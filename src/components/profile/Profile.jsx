        ...
        <div className="xxl:max-w-106 w-auto h-auto xxl:max-h-126">
          <div className="max-w-106 h-117 object-fill overflow-hidden rounded-xl">
            <img
              ...
              src={person}
              alt="Mayuri Atole - MCA Student & Data Scientist"
            />
          </div>
...
<div className={`text-xs xs:text-[16px] lg:text-lg font-normal max-md:text-center text-gray-600`}>
  <p className={``}>
    Self-taught <span className="font-bold">Data Scientist</span> crushing sugarcane disease detection 
    with CNN (92.2% accuracy) and image classification!
  </p>
  <p className="mt-3">
    YOLOv11 agentic AI | Kaggle Top 20% | MERN full-stack. 
    Turning agriculture into AI superpower 🌾
  </p>
</div>
          ...
          <div className="mt-8 flex max-md:justify-center">
            ...
            <a
              ...
              href="/assets/resume/Mayuri_Atole_Resume.pdf"
