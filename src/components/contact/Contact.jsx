...
const addressData = [
  {
    icon: faLocationDot,
    title: "Address",
    description: "chinchwad  pune, Maharashtra, India",
  },
  {
    icon: faEnvelope,
    title: "My Email",
    description: "atolemayuri17@mail.com",
  },
  {
    icon: faPhone,
    title: "Call Me Now",
    description: "9527704170",
  },
];
...
const Contact = () => {
 ...
 MCA graduate seeking Software Engineer, Data Scientist, or ML Engineer roles. 
